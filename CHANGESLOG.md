...
## 3.0.0 - 2026-03-16
### Fixed
- [issue 19](https://github.com/adinan-cenci/psr-7/issues/19): Updated the definition of `AdinanCenci\Psr7\Response::withAddedCookie()`, breaking compatibility with previous versions.
